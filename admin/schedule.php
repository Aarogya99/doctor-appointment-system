            ...
            <table border="0" width="100%" style="border-spacing: 0;margin:0;padding:0;margin-top:25px;">
                ...
                <?php
                    if($_POST){
                        ...
                        $sqlmain = "select schedule.scheduleid, schedule.title, doctor.docname, schedule.scheduledate, schedule.scheduletime, schedule.endtime, schedule.nop from schedule inner join doctor on schedule.docid=doctor.docid ";
                        ...
                        $sqlmain = "select schedule.scheduleid, schedule.title, doctor.docname, schedule.scheduledate, schedule.scheduletime, schedule.endtime, schedule.nop from schedule inner join doctor on schedule.docid=doctor.docid order by schedule.scheduledate desc";
                    }
                ?>
                        ...
                        <tbody>
                            <?php
                                ...
                                if($result->num_rows == 0){
                                    ...
                                    <a class="non-style-link" href="schedule.php"><button class="login-btn btn-primary-soft btn" style="margin-top:10px;">Show all Sessions</button></a>
                                    </td>
                                    </tr>';
                                } else {
                                    for ($x=0; $x < $result->num_rows; $x++) {
                                        ...
                                        echo '<tr>
                                            ...
                                            <td style="text-align:center;">' . substr($scheduledate, 0, 10) . '</td>
                                            <td style="text-align:center;">' . substr($scheduletime, 0, 5) . '</td>
                                            <td style="text-align:center;">' . substr($endtime, 0, 5) . '</td>
    ...
    if($_GET){
        ...
        if($action == 'add-session'){
            ...
            echo '          </select><br><br>
                        ...
                        <tr>
                            <td class="label-td" colspan="2">
                                <input type="number" name="nop" class="input-text" min="0" placeholder="Max appointments for this session" required><br>
                            </td>
                        </tr>
                        <tr>
                            <td class="label-td" colspan="2">
                        ...
                        <tr>
                            <td class="label-td" colspan="2">
                                <label for="scheduletime" class="form-label">Session Start Time: </label>
                            </td>
                        </tr>
                        <tr>
                            <td class="label-td" colspan="2">
        ...
        elseif($action == 'view'){
            $sqlmain = "select schedule.scheduleid, schedule.title, doctor.docname, schedule.scheduledate, schedule.scheduletime, schedule.endtime, schedule.nop from schedule inner join doctor on schedule.docid=doctor.docid where schedule.scheduleid=$id";
            $result = $database->query($sqlmain);
            $row = $result->fetch_assoc();
                ...
                <center>
                    ...
                    <div class="abc scroll" style="display: flex;justify-content: center;">
                        <table width="80%" class="sub-table scrolldown add-doc-form-container" border="0">
                            ...
                            <tr>
                                <td class="label-td" colspan="2"><label for="name" class="form-label">Session Title: </label></td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">'.htmlspecialchars($title).'<br><br></td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2"><label for="Email" class="form-label">Doctor of this session: </label></td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">'.htmlspecialchars($docname).'<br><br></td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2"><label for="nic" class="form-label">Scheduled Date: </label></td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">'.htmlspecialchars($scheduledate).'<br><br></td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2"><label for="Tele" class="form-label">Scheduled Start Time: </label></td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">'.htmlspecialchars($scheduletime).'<br><br></td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2"><label for="Tele" class="form-label">Scheduled End Time: </label></td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">'.htmlspecialchars($endtime).'<br><br></td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2"><label for="spec" class="form-label"><b>Patients Already Registered:</b> ('.$result12->num_rows.'/'.$nop.')</label><br><br></td>
                            </tr>
                            <tr>
                                <td colspan="4">
                                    <center>
                                        ...
                                        <table width="100%" class="sub-table scrolldown" border="0">
                                            ...
                                            if($result12->num_rows == 0){
                                                echo '<tr>
                                                    <td colspan="7" style="text-align:center; padding:50px;">
                                                    <img src="../img/notfound.svg" width="25%"><br>
                                                    <p class="heading-main12" style="font-size:20px;color:rgb(49, 49, 49)">No appointments found!</p>
                                                    <a class="non-style-link" href="appointment.php"><button class="login-btn btn-primary-soft btn" style="margin-top:10px;">Show all Appointments</button></a>
                                                    </td>
                                                </tr>';
                                            } else {
                                                for ($x=0; $x<$result12->num_rows; $x++){
                                                    ...
                                                    echo '<tr style="text-align:center;">
                                                        <td>'.substr(htmlspecialchars($pid),0,15).'</td>
                                                        <td style="font-weight:600;padding:25px">'.substr(htmlspecialchars($pname),0,25).'</td>
                                                        <td style="text-align:center;font-size:23px;font-weight:500; color: var(--btnnicetext);">'.$apponum.'</td>
                                                        <td>'.substr(htmlspecialchars($ptel),0,25).'</td>
                                                    </tr>';
                                                }
                                            }
                                            echo '</tbody>
